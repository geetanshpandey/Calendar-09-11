      ...
      <Card className="w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center space-x-6 mb-6">
            ...
            />
            <div className="flex items-center text-4xl font-semibold text-gray-900 dark:text-white">
              <span className="text-3xl">Cal</span> {/* 1.5x text size increase */}
              <span className="text-blue-600 text-3xl">Marshal</span> {/* 1.5x text size increase */}
            </div>
          </div>
