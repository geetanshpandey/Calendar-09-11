      ...
      <div>
        <div>
          ...
          <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
            Get to know Unimanage, the scheduling planner for everyone. Focus on
            your meetings, not on scheduling them. Free for individuals.
          </p>
          {/* Buttons */}
